...
Since many functions are being reused, it may become apparent that it will be easier to include no duplicate functions and call them when needed. However, while coding this, I broke the project into three projects, singleplayer, multiplayer, and autonomous. Doing this was easiest, making it easier to understand how each mode works as all the code is together. An issue that I could kick myself for was when I was doing up the autonomous mode. When I got the mode working how I wanted it to work, I still had to do the CSV part and graph my results. I wanted it to write if the dealer got a blackjack, the player got a blackjack, or if no one got one. I could not wrap my head around doing that, as every method I tried was not working. One of my attempts consisted of setting no_blackjack to True, and then if a blackjack arose, it would set it to False. This did not work, so I gathered my last couple of good brain cells and tried writing precisely what I wanted it to print. Suppose no dealer_blackjack_game or player_blackjack_game writes True. Line 662 shows this as "not(dealer_bj_game or player_bj_game)". It just worked, and I kept it. I was happy
